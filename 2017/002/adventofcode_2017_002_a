...
int main() {
  ...
  short input[][colonnes] = {{493 ,458 ,321 ,120 ,49  ,432 ,433 ,92  ,54  ,452 ,41  ,461 ,388 ,409 ,263 ,58  },
  ...
  short lines = sizeof(input)/sizeof(input[0]), i = 0, j = 0, min, max, resultat = 0;
  
  for(;i<lines;i++) {
    min = input[i][0], max = 0;
    for(j=0;j<colonnes;j++) {
      if (input[i][j] < min && input[i][j] != 0) min = input[i][j];
      if (input[i][j] > max && input[i][j] != 0) max = input[i][j];
    }
    resultat+=(max-min);
  }
