...
int main() {
  ...
  const short colonnes = 16;
  short string[][colonnes] = {{493 ,458 ,321 ,120 ,49  ,432 ,433 ,92  ,54  ,452 ,41  ,461 ,388 ,409 ,263 ,58  },
                              ...
                              {788 ,1263,1119,1391,1464,179 ,1200,621 ,1304,5  5,700 ,1275,226 ,57  ,43  ,51  },
  ...
  short lines = sizeof(string)/sizeof(string[0]), i = 0, j = 0, k = 0, resultat = 0;
  
  for(i=0;i<lines;i++) {
    for(j=0;j<colonnes;j++) {
      for(k=0;k<colonnes-1;k++){
        short a = string[i][j], b = string[i][(k+j+1)%colonnes];
        if (a % b == 0){ resultat += a/b; break;}
      }
    }
  }
